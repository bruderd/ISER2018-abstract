...
\begin{document}
\mainmatter
\title{Model-Based Control of Parallel Combinations of Fiber-Reinforced Soft Actuators}
\titlerunning{Model-Based Control of Parallel Combinations of Soft Actuators}
...
\newpage
\input{sections/technical-approach.tex}
\newpage
